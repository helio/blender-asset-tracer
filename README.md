...
poetry build
twine check dist/blender-asset-tracer-1.15-dev0.tar.gz dist/blender_asset_tracer-1.15-dev0-*.whl
twine upload -r rsa dist/blender-asset-tracer-1.15-dev0.tar.gz dist/blender_asset_tracer-1.15-dev0-*.whl
```
